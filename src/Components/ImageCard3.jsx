          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-start gap-2">
              ...
              <p className="text-[#497696] text-base font-normal leading-relaxed">
                After the transcription is complete, the transcript will appear
                in a scrollable, interactive text area.
              </p>
            </div>
            {/* Point 2 */}
            <div className="flex items-start gap-2">
              ...
              <img src="/arrow.svg" alt="" />
              <p className="text-[#497696] text-base font-normal leading-relaxed">
                Use the collapsible sections to navigate through the transcript
            ...
            <div className="flex items-start gap-2">
              ...
              <img src="/arrow.svg" alt="" />
              <p className="text-[#497696] text-base font-normal leading-relaxed">
                Save your highlights, add tags, or generate summaries based on
                your preferences.
              </p>
            </div>
          </div>
