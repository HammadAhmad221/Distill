  ...
  const features = [
    {
      ...
      title: "Transcription",
      description:
        "Easily convert audio files into accurate text with multi-language support.",
    ...
    },
    {
      ...
      description:
        "Highlight and save key sections with collapsible navigation.",
    ...
    },
    {
      ...
      description:
        "Organize, tag, and search your saved transcripts and summaries.",
    ...
    },
    {
      ...
      description:
        "Get answers to your questions based on the transcript content.",
    ...
    },
    {
      ...
      description:
        "Efficiently organise your audio content with folders and tags.",
  ...
  return (
    <div className="bg-gray-900 text-white p-32 max-[1000px]:p-4 text-center flex flex-col items-center gap-14">
      <div className="w-[33%] max-[1000px]:w-[80%]">
        <h1 className="text-4xl max-[600px]:text-3xl font-bold mb-5 ">
          Unlock the Power of Audio Content
        </h1>
        <p className="">
          Transform the way you interact with and extract knowledge from
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {features.map((feature, index) => (
          ...
          >
            <div
              className="bg-cover bg-center h-10 w-10 flex items-center justify-center"
              style={{
            ...
            <a href="#" className="text-blue-400 hover:underline flex gap-4">
