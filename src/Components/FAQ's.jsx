  ...
  const faqData = [
    {
      ...
      answer: "We currently support multiple languages, including English, Spanish, and French. More languages will be added soon."
    },
    {
    ...
    },
    {
      ...
      answer: "The chatbot processes transcripts and provides answers based on the content."
    },
    {
      question: "How Do I Organize My Saved Content?",
      answer: "You can organize your saved content in folders and tag them for easy navigation."
    },
    {
      question: "Is My Data Secure?",
      answer: "Yes, all your data is securely encrypted and stored with industry-standard protocols."
    }
  ];
  ...
  return (
    <div className='bg-gray-100 py-32'>
      <div className="max-w-2xl mx-auto">
        <h2 className="text-3xl font-bold text-center mb-6">Questions About Our Services?</h2>
