...
//   return (
//     <div className="w-full h-[60px] px-4 py-5 bg-white rounded-xl border border-[#3f3eed] flex-col justify-start items-start gap-2.5 inline-flex">
...
//         {/* Progress Bar */}
//         <div
//           className="w-[76%] h-[0px] flex-col justify-center items-start gap-[0.25px] inline-flex"
//           onClick={handleSeek}
//         >
//           <div className="w-[643px] h-[0px] border border-[#e5e4ff]"></div>
//           <div
...
//           <div className="text-center text-black text-sm font-normal font-['Space Grotesk']">
//             {formatTime(duration)}
//           </div>
