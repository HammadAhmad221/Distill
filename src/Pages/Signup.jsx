...
const Signup = () => {
  return (
    <div className='bg-gray-100 font-space'>
        ...
        <div className="text-center text-white text-4xl font-bold">Sign up</div>
        <div className="text-center"><span className="text-[#3f3eed] text-base font-normal">Home </span><span className="text-white text-base font-normal">/ Signup</span></div>
        </div>
        <SignupForm/>
    </div>
  )
...
const SignupForm = () => {
  ...
  return (
    <div className="flex items-center justify-center w-full">
      ...
      <div className="text-center text-[#3f3eed] text-lg font-bold leading-snug">Start your Journey</div>
        <h2 className="text-3xl font-bold text-center mb-10">Signup to continue</h2>
        ...
        <div className="text-[#557593] text-base font-normal leading-tight tracking-tight text-center mt-8">Already have an account?<a href='/login' className='text-[#3F3EED]'> Sign in now</a></div>
        {/* Divider */}
